                                            ...
                                            <div>
                                                <label class="custom_check ">
                                                    <input type="radio" name="select_specialist"
                                                        value="{{ $item->id }}" <?php if ($id == $item->id) {
                                                            echo 'checked';
                                                        } ?>>
                                        ...
                                        <div class="doctor-img">
                                            <a href="{{ url('doctor-profile/' . $doctor->id) }}">
                                                <img src="{{ asset('images/doctors/' . $doctor->profile_photo) }}"
                                                    class="" alt="User Image" height="147" width="150">
                                            </a>
                                        </div>
                                        <div class="doc-info-cont">
                                            <h4 class="doc-name">{{ $doctor->name }}</h4>
                                            <p class="doc-speciality">{{ $doctor->designa }}</p>
                                            <?php
                                            $cat = App\Category::where('id', $profile->cat_id)->first();
                                            ?>
                                            <p class="doc-department"><img src="{{ asset('images/' . @$cat->logo) }}"
                                                    class="img-fluid" alt="0">{{ @$cat->name }}</p>
                                            <div class="rating">
                                                <?php
                                            ...
                                            <div class="clinic-details">
                                                <p class="doc-location"><i class="fas fa-map-marker-alt"></i>
                                                    {{ $profile->present_address }} <a href="javascript:void(0);">Get
                                                        Directions</a></p>
                                            </div>
                                    ...
                                    <div class="doc-info-right">
                                        ...
                                        <div class="clinic-booking">
                                            <a class="view-pro-btn"
                                                href="{{ url('doctor-profile/' . $profile->slug) }}">View
                                                Profile</a>
