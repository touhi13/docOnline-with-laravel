                    ...
                    <div class="doctor-widget">
                        <div class="doc-info-left">
                            <div class="doctor-img">
                                <img src={{ asset('images/doctors/' . $doctor->profile_photo) }} class="img-fluid"
                                    alt={{ $doctor->name }}>
                            </div>
                            <div class="doc-info-cont">
                                ...
                                <p class="doc-speciality">
                                    @php
                                        if ($doctor->degrees && count($doctor->degrees) > 0) {
                                            $degreeTitles = array_map(function ($degree) {
                                                return $degree->title;
                                            }, $doctor->degrees);
                                        
                                            echo implode(', ', $degreeTitles);
                                        }
                                    @endphp
                                </p>
                                <h5 class="doc-department"><span class="mr-2"><i class="fas fa-user-md"></span></i>
                                    @forelse($doctor->specialities as $spec)
                                        {{ $spec->profession_name }}
                                        @if (!$loop->last)
                                            ,
                                        @endif
                                    @empty
                                ...
                                <a href={{ url('claim-profile/' . $doctor->id) }}
                                    class="text-danger">{{ $doctor->first_name . ', is this you? Claim and update this profile.' }}
                                </a>
                                <div class="rating">
                                ...
                                <div class="clinic-details">
                                    <p class="doc-location"><i class="fas fa-map-marker-alt"></i>
                                        {{ $doctor->district->district }} - <a href="javascript:void(0);">Get Directions</a>
                                    </p>
                                </div>
                        ...
                        <div class="doc-info-right">
                            <div class="clini-infos">
                                <ul>
                                    ...
                                    <li><i class="fas fa-map-marker-alt"></i> {{ $doctor->district->district }} </li>
                    ...
                    <div class="tab-content pt-0">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-9">
                                    ...
                                    <div class="widget experience-widget">
                                        ...
                                        <div class="experience-box">
                                            <ul class="experience-list">
                                                @foreach ($doctor->newExperiences->sortByDesc('is_current') as $exp)
                                                    <li>
                                                        <div class="experience-user">
                                                            <div class="before-circle"></div>
                                                        </div>
                                                        <div class="experience-content">
                                                            <div class="timeline-content">
                                                                <a href="#/"
                                                                    class="name">{{ $exp->organization_name }}
                                                                </a>
                                                                <div>{{ $exp->department }}</div>
                                                                <span class="time">
                                                                    {{ date('d M Y', strtotime($exp->from)) }} -
                                                                    @if ($exp->to === null)
                                                                        Present
                                                                    @else
                        ...
                        <div role="tabpanel" id="doc_reviews" class="tab-pane fade">
                            ...
                            <div class="widget review-listing">
                                ...
                                @if ($showAllReviewsButton)
                                    <div class="all-feedback text-center">
                                        <a href="{{ url('all-reviews/' . $doctor->generateSlug()) }}"
                                            class="btn btn-primary btn-sm">
                                            Show all reviews <strong>({{ $reviewCount }})</strong>
                                        </a>
                                    </div>
                                @endif
                                <!-- /Show All -->
                            ...
                            <div class="write-review">
                                ...
                                <!-- Write Review Form -->
                                <form method="POST" action="{{ url('doctor-review') }}">
                                    @csrf
